...
[
  "indicator micro_unsatisfied_agent_count: Micro lacks an elementary primitive",
  "indicator micro_fraction_unsatisfied: Micro lacks an elementary primitive",
  ...
  "indicators": [
    {
      ...
      "scientific_rationale": "The dissatisfied event count is an elementary micro outcome; counting per step tracks how many individuals experience local dissatisfaction."
    },
    {
    ...
    },
    {
      ...
      "scale": "micro",
      "entity_scope": "elementary_event",
      "entities": "agents with moved flag and population",
      "source_fields": [
        "moved",
        "agent_count"
      ],
    ...
    },
    {
      ...
      "scale": "micro",
      "entity_scope": "interaction",
      "entities": "agents with boundary exposure and population",
      "source_fields": [
        "boundary_agent",
        "agent_count"
      ],
