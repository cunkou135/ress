...
[
  "1 validation error for IndicatorGeneration\n  Value error, duplicate indicator id [type=value_error, input_value={'scenario': 'schelling',... segregation outcomes.'}, input_type=dict]\n    For further information visit https://errors.pydantic.dev/2.13/v/value_error"
]
Return a complete corrected object without using simulation outcomes.
{
  ...
  "indicators": [
    ...
    },
    {
      ...
      "parameter_associations": [],
      "scientific_rationale": "The upper tail of local similarity identifies how many agents reside in highly homogeneous local environments."
    },
    {
