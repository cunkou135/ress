...
[
  "indicator micro_unhappy_fraction: sum requires numeric input",
  "indicator micro_moved_fraction: sum requires numeric input",
  "indicator micro_boundary_fraction: sum requires numeric input",
  "indicator meso_district_local_similarity_mean: Meso lacks non-trivial organization",
  ...
  "indicator meso_district_move_distance_mean: Meso lacks non-trivial organization",
  "indicator meso_district_destination_similarity_mean: Meso lacks non-trivial organization",
  "indicator meso_district_neighbour_count_mean: Meso lacks non-trivial organization",
  "indicator macro_global_move_count: sum requires numeric input",
...
Return a complete corrected object without using simulation outcomes.
{
  ...
  "indicators": [
      ...
      "parameter_associations": [
        {
          ...
          "rationale": "Tolerance changes the satisfaction threshold that triggers moves, so average local similarity may shift, but the direction depends on relocation flows."
        }
      ],
      ...
      "parameter_associations": [
        {
          ...
          "relationship": "direct",
          "expected_indicator_direction": "increase",
          "rationale": "Higher move probability increases the chance that unsatisfied agents attempt relocation, so the moved fraction rises, all else equal."
        }
      ],
      ...
      "parameter_associations": [
        {
          ...
          "relationship": "direct",
          "expected_indicator_direction": "mixed",
          "rationale": "Move probability controls the volume of relocation, changing which pairs of local similarity and distance are observed; sign is not preset."
        }
      ],
      ...
      "parameter_associations": [
        {
          ...
          "relationship": "direct",
          "expected_indicator_direction": "mixed",
          "rationale": "Higher destination preference can concentrate destination similarity values, changing their spread, but the effect direction depends on sampled vacancies."
        }
      ],
      ...
      "parameter_associations": [
        {
          ...
          "relationship": "direct",
          "expected_indicator_direction": "mixed",
          "rationale": "Move probability changes the number of relocations and may alter the dispersion of relocation distances without a preset direction."
        }
      ],
      "scientific_rationale": "Dispersion of relocation distance captures variability in the extent of individual moves."
    },
    {
      "id": "meso_district_local_similarity_mean",
      "semantic_name": "District mean local similarity",
      "scientific_definition": "Average across fixed spatial districts of district-level mean same-group local similarity at each step.",
      "phenomenon": "Schelling segregation dynamics",
      "scale": "meso",
      ...
      "parameter_associations": [
        {
          ...
          "expected_indicator_direction": "mixed",
          "rationale": "Tolerance affects individual moves and therefore district-level settlement patterns, but aggregated direction is not predetermined."
        }
      ],
      "scientific_rationale": "Uses public district membership grouping to summarize real district organization without treating the district as an inferred outcome."
    },
    {
    ...
    },
    {
      ...
      "semantic_name": "Mean district unsatisfied fraction",
      "scientific_definition": "Average across fixed spatial districts of district-level unsatisfied agent fraction at each step.",
      "phenomenon": "Schelling segregation dynamics",
      "scale": "meso",
      "entity_scope": "district",
      "entities": "spatial districts",
      ...
      "scientific_rationale": "Aggregates district-level dissatisfaction prevalence across real spatial subdomains."
    },
    {
      ...
      "parameter_associations": [
        {
          ...
          "relationship": "indirect",
          "expected_indicator_direction": "mixed",
          "rationale": "Tolerance changes the baseline dissatisfaction threshold, which can alter district-level disparities."
        }
      ],
    ...
    },
    {
      ...
      "semantic_name": "Mean district boundary-exposed fraction",
      "scientific_definition": "Average across fixed spatial districts of district-level fraction of agents with at least one different-group neighbour.",
      "phenomenon": "Schelling segregation dynamics",
      "scale": "meso",
      "entity_scope": "district",
      "entities": "spatial districts",
      ...
      "scientific_rationale": "District-level boundary exposure summarizes local intergroup contact within real spatial subdomains."
    },
    {
      "id": "meso_district_move_distance_mean",
      "semantic_name": "Mean district relocation distance",
      "scientific_definition": "Average across fixed spatial districts of district-level mean relocation distance at each step.",
      "phenomenon": "Schelling segregation dynamics",
      "scale": "meso",
      "entity_scope": "district",
      "entities": "spatial districts",
      ...
      "scientific_rationale": "Aggregates relocation distance within public districts before averaging over district organization."
    },
    {
      "id": "meso_district_destination_similarity_mean",
      "semantic_name": "Mean district destination similarity",
      "scientific_definition": "Average across fixed spatial districts of district-level mean destination same-group similarity at each step.",
      "phenomenon": "Schelling segregation dynamics",
      "scale": "meso",
      "entity_scope": "district",
      "entities": "spatial districts",
      ...
      "scientific_rationale": "Captures district-level destination exposure after relocation within real public spatial domains."
    },
    {
      "id": "meso_district_neighbour_count_mean",
      "semantic_name": "Mean district occupied neighbour count",
      "scientific_definition": "Average across fixed spatial districts of district-level mean occupied Moore-neighbour count at each step.",
      "phenomenon": "Schelling segregation dynamics",
      "scale": "meso",
      "entity_scope": "district",
      "entities": "spatial districts",
      ...
      "parameter_associations": [],
      "scientific_rationale": "Summarizes local occupancy within each public spatial district and then across district-level values."
    },
    {
    ...
    },
    {
      ...
      "scientific_rationale": "Total moves is a whole-system relocation outcome derived directly from elementary relocation events."
    },
    {
  ...
  "interpretation_boundary": "Descriptive observables only; no causal or predictive claims. District summaries use fixed public spatial districts and do not infer segregation outcomes."
}
