...
[
  ...
  "indicator meso_neighborhood_opinion_alignment: Meso lacks non-trivial organization",
  "indicator meso_neighborhood_shift_mean: Meso lacks non-trivial organization",
  "indicator meso_neighborhood_distance_mean: Meso lacks non-trivial organization",
  "indicator meso_neighborhood_backfire_mean: network neighborhood mean requires numeric values",
  "indicator meso_neighborhood_backfire_mean: Meso lacks non-trivial organization",
...
Return a complete corrected object without using simulation outcomes.
{
  ...
  "indicators": [
    ...
    },
    {
      ...
      "scientific_definition": "Mean local neighborhood opinion averaged over all network neighborhoods at each step.",
      "phenomenon": "Opinion dynamics",
      "scale": "meso",
      ...
      "scientific_rationale": "Summarizes local-domain opinion organization using the observed network adjacency."
    },
    {
      "id": "meso_neighborhood_opinion_std",
      "semantic_name": "Neighborhood opinion variation",
      "scientific_definition": "Standard deviation across network neighborhoods of local mean opinion at each step.",
      "phenomenon": "Opinion dynamics",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "local network neighborhoods",
      ...
      "scientific_rationale": "Captures heterogeneity among local opinion neighborhoods."
    },
    {
      "id": "meso_neighborhood_abs_opinion_mean",
      "semantic_name": "Neighborhood absolute opinion mean",
      "scientific_definition": "Mean absolute local neighborhood opinion averaged over all neighborhoods at each step.",
      "phenomenon": "Opinion dynamics",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "local network neighborhoods",
      ...
      "scientific_rationale": "Measures local neighborhood opinion extremity using network-defined neighborhoods."
    },
    {
      "id": "meso_neighborhood_opinion_alignment",
      "semantic_name": "Individual-neighborhood opinion alignment",
      "scientific_definition": "Correlation between agents and their local network neighborhood mean opinion at each step.",
      "phenomenon": "Opinion dynamics",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "local network neighborhoods",
      ...
      "scientific_rationale": "Measures local opinion coherence between individuals and their network-defined communities."
    },
    {
      "id": "meso_neighborhood_shift_mean",
      "semantic_name": "Neighborhood mean opinion shift",
      "scientific_definition": "Mean local neighborhood opinion update averaged over all neighborhoods at each step.",
      "phenomenon": "Opinion dynamics",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "local network neighborhoods",
      ...
      "scientific_rationale": "Captures local neighborhood-level opinion change organization."
    },
    {
      "id": "meso_neighborhood_shift_std",
      "semantic_name": "Neighborhood opinion shift variation",
      "scientific_definition": "Standard deviation across network neighborhoods of local mean opinion shift at each step.",
      "phenomenon": "Opinion dynamics",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "local network neighborhoods",
      ...
      "scientific_rationale": "Measures heterogeneity of opinion change across local network neighborhoods."
    },
    {
      "id": "meso_neighborhood_distance_mean",
      "semantic_name": "Neighborhood mean interaction distance",
      "scientific_definition": "Mean local neighborhood interaction distance averaged over all neighborhoods at each step.",
      "phenomenon": "Opinion dynamics",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "local network neighborhoods",
      ...
      "scientific_rationale": "Captures local-domain encounter distance organization on the interaction network."
    },
    {
      "id": "meso_neighborhood_backfire_mean",
      "semantic_name": "Neighborhood mean backfire prevalence",
      "scientific_definition": "Mean local neighborhood backfire fraction averaged over all neighborhoods at each step.",
      "phenomenon": "Opinion dynamics",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "local network neighborhoods",
      ...
      "scientific_rationale": "Measures local-domain prevalence of repulsive encounter events."
    },
    {
  ...
  "interpretation_boundary": "Indicators are computable descriptive observables derived only from public raw simulation fields and the supplied grammar. They are not causal, statistical, or predictive claims, and all time series should be interpreted as within-simulation measurements only."
}
