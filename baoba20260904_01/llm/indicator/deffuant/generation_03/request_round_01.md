...
[
  ...
  "indicator meso_neighborhood_extreme_fraction: Meso lacks non-trivial organization",
  "indicator meso_neighborhood_accepted_fraction: Meso lacks non-trivial organization",
  "indicator meso_neighborhood_rejection_fraction: Meso lacks non-trivial organization",
  "indicator meso_neighborhood_rewiring_fraction: Meso lacks non-trivial organization",
  "indicator meso_neighborhood_mean_interaction_distance: Meso lacks non-trivial organization",
  "indicator meso_neighborhood_mean_agent_shift: Meso lacks non-trivial organization",
...
Return a complete corrected object without using simulation outcomes.
{
  ...
  "indicators": [
    ...
    {
      "id": "micro_interaction_distance_median",
    ...
    {
      "id": "micro_positive_shift_fraction",
    ...
    {
      "id": "micro_opinion_shift_correlation",
    ...
    },
    {
      ...
      "semantic_name": "Neighborhood mean opinion",
      "scientific_definition": "Mean across network neighborhoods of average neighbor opinion at each step.",
      "phenomenon": "local opinion organization",
      "scale": "meso",
      ...
      "temporal_aggregation": {"op": "identity", "window": null},
      "parameter_associations": [],
      "scientific_rationale": "Neighborhood mean opinion captures how local interaction domains organize around typical opinion states."
    },
    {
    ...
    {
      "id": "meso_neighborhood_extreme_fraction",
      "semantic_name": "Neighborhood extreme opinion prevalence",
      "scientific_definition": "Mean across network neighborhoods of the fraction of neighbors with absolute opinion at least 0.75.",
      ...
      "temporal_aggregation": {"op": "identity", "window": null},
      "parameter_associations": [],
      "scientific_rationale": "Neighborhood extreme opinion prevalence measures how strongly polarized opinions concentrate within local social neighborhoods."
    },
    {
      "id": "meso_neighborhood_accepted_fraction",
      "semantic_name": "Neighborhood assimilation interaction prevalence",
      "scientific_definition": "Mean across network neighborhoods of the fraction of neighbor interactions that qualify for assimilation.",
      "phenomenon": "local assimilation",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "network neighborhoods",
      ...
      "temporal_aggregation": {"op": "identity", "window": null},
      "parameter_associations": [],
      "scientific_rationale": "Neighborhood assimilation interaction prevalence shows how often local social domains support opinion convergence."
    },
    {
      "id": "meso_neighborhood_rejection_fraction",
      "semantic_name": "Neighborhood rejection interaction prevalence",
      "scientific_definition": "Mean across network neighborhoods of the fraction of neighbor interactions that are rejected.",
      "phenomenon": "local interaction rejection",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "network neighborhoods",
      ...
      "temporal_aggregation": {"op": "identity", "window": null},
      "parameter_associations": [],
      "scientific_rationale": "Neighborhood rejection interaction prevalence captures how often local social interactions fail to produce opinion change."
    },
    {
      "id": "meso_neighborhood_rewiring_fraction",
      "semantic_name": "Neighborhood adaptive rewiring prevalence",
      "scientific_definition": "Mean across network neighborhoods of the fraction of neighbor ties successfully rewired.",
      ...
      "temporal_aggregation": {"op": "identity", "window": null},
      "parameter_associations": [],
      "scientific_rationale": "Neighborhood adaptive rewiring prevalence indicates how strongly local social domains remodel their interaction ties."
    },
    {
      "id": "meso_neighborhood_mean_interaction_distance",
      "semantic_name": "Neighborhood mean interaction distance",
      "scientific_definition": "Mean across network neighborhoods of average neighbor interaction opinion distance.",
      "phenomenon": "local interaction distance",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "network neighborhoods",
      ...
      "temporal_aggregation": {"op": "identity", "window": null},
      "parameter_associations": [],
      "scientific_rationale": "Neighborhood mean interaction distance characterizes the typical opinion separation in local social encounters."
    },
    {
      "id": "meso_neighborhood_mean_agent_shift",
      "semantic_name": "Neighborhood mean opinion update",
      "scientific_definition": "Mean across network neighborhoods of average neighbor opinion update at each step.",
      "phenomenon": "local opinion change",
      "scale": "meso",
      "entity_scope": "neighborhood",
      "entities": "network neighborhoods",
      ...
      "temporal_aggregation": {"op": "identity", "window": null},
      "parameter_associations": [],
      "scientific_rationale": "Neighborhood mean opinion update captures how much local social domains shift their opinions on average."
    },
    {
  ...
  "interpretation_boundary": "These indicators are descriptive observables from the supplied simulator semantics. No causal, statistical, or intervention support is claimed, and no candidate relationships or predictions are proposed."
}
